...
for qmp in qmprog:
    for spect in spectyp:
        ...
        oth_freqs = []
        oth_inten = []
#        csv_web = qmp + "_h2o_hf_nosmd_" + spect + "_web.csv"
        csv_web10 = qmp + "_h2o_hf_nosmd_" + spect + "-10.csv"
        csv_web20 = qmp + "_h2o_hf_nosmd_" + spect + "-20.csv"
        csv_oth = qmp + "_h2o_hf_nosmd_" + spect + "_oth.csv"
...
#           plt.title(plottitle)
            ...
            plt.tight_layout()
            pngname = qmp + "_h2o_hf_nosmd_" + spect + "_plots.png"
            plt.savefig(pngname)
          # plt.show()
            plt.close()
